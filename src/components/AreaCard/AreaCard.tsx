...
export const Area: FunctionComponent<AreaProps> = ({areaName}) => {
    ...
    const {viewer, metric, recordType, startDate, endDate} = useContext(SettingsContext);
    ...
    const timeSeries = getPlotSeries(data.timeSeries, metric, recordType, startDate, endDate);
